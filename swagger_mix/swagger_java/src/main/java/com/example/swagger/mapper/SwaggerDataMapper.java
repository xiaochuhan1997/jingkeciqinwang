...
public interface SwaggerDataMapper extends BaseMapper<SwaggerData> {
    ...
    @Insert("INSERT INTO swagger_data (method, input_param, input_param_dec, output_param, output_param_dec, create_time,api_url, server_url, tag,summary, case_no,case_dec) " +
            "VALUES (#{swaggerData.method}, #{swaggerData.inputParam}, #{swaggerData.inputParamDec}, #{swaggerData.outputParam}, #{swaggerData.outputParamDec}, #{swaggerData.createTime}," +
